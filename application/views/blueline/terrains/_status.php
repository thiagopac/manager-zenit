...
<div class="form-group">
    <label for="users"><?=$this->lang->line('application_terrain_status_user_notification');?></label>
    <?php
        $options = array();
        $user = array();
        ...
        foreach ($status->terrain_status_receiver as $workers):
	...
	<div class="modal-footer">
        <input type="submit" name="send" class="btn btn-primary silent-submit" data-section="terrain" value="<?=$this->lang->line('application_save');?>"/>
