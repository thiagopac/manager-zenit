	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <div class="row">
            ...
            <div class="pull-right">
                <div class="col-md-1">
                    <a href="<?=base_url()?>terrains/edittag/create" data-toggle="mainmodal" class="btn btn-secondary">
			...
			<table id="alltags" class="table" cellspacing="0" cellpadding="0">
				...
				<tr id="<?=$tag->id;?>">
					...
					<td class="option" width="8%">
						<a href="<?=base_url()?>terrains/edittag/edit/<?=$tag->id;?>" class="btn-option" data-toggle="mainmodal">
