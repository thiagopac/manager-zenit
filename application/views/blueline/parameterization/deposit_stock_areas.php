        ...
        <div class="box-shadow">
            <div class="table-head">
                ...
                <span class="pull-right">
					<a href="<?=base_url()?>parameterization/deposit_stock_area_create" class="btn btn-primary" data-toggle="mainmodal">
                    ...
                    <?php foreach ($deposit_stock_areas as $deposit_stock_area):?>
                        ...
                        <tr id="<?=$deposit_stock_area->deposit_id;?>">
                            ...
                            <td class="option" width="8%">
                                ...
                                <a href="<?=base_url()?>parameterization/deposit_stock_area_update/<?=$deposit_stock_area->deposit_id;?>/<?=$deposit_stock_area->stock_area_id;?>" class="btn-option" data-toggle="mainmodal">
