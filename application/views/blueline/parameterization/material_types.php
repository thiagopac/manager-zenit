        ...
        <div class="box-shadow">
            <div class="table-head">
                ...
                <span class="pull-right">
					<a href="<?=base_url()?>parameterization/material_type_create" class="btn btn-primary" data-toggle="mainmodal">
