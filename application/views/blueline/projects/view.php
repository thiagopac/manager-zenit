        ...
        <li id="milestoneLI_<?=$milestone->id;?>" class="hasItems">
            <h1 class="milestones__header ui-state-disabled">
               <i class="ion-android-list milestone__header__icon"></i>
                <?=$milestone->name?>
                <a class="ajax-silent dynamic-reload" data-reload="areas-list" href="<?=base_url()?>projects/milestones/<?=$project->id;?>/copy/<?=$milestone->id;?>"><i style="vertical-align: middle; color: white" class="icon dripicons-copy milestone__header__icon" title="<?=$this->lang->line('application_copy_milestone')?>"></i></a>
                <span class="pull-right">
