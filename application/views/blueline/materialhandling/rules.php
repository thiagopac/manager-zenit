<div id="row">
    ...
    <div class="col-md-12 col-lg-12">
        <div class="box-shadow">
            ...
            <div class="table-div responsive">
                <table id="material_rules" class="data-no-search table noclick" cellspacing="0" cellpadding="0">
                    <thead>
                    <th class="hidden-xs hidden-sm" style="width:25px" class="">
                    ...
                    <th class="hidden-md hidden-lg">
                        <?=$this->lang->line('application_deposit_abrv');?>
                    </th>
                    <th class="hidden-sm hidden-xs">
                        <?=$this->lang->line('application_material');?>
                    </th>
                    <th class="hidden-md hidden-lg">
                        <?=$this->lang->line('application_material_abrv');?>
                    </th>
                    <th class="hidden-sm hidden-xs">
                        <?=$this->lang->line('application_verification');?>
                    </th>
                    <th class="hidden-md hidden-lg">
                        <?=$this->lang->line('application_verification_abrv');?>
                    </th>
                    <th class="">
                    ...
                    <?php foreach ($material_rules as $rule):?>
                        ...
                        <tr id="<?=$rule->id;?>">
                            <td class="hidden-xs hidden-sm" class="">
                                <?=$rule->id;?>
                            </td>
                            <td>
    ...
    <div class="col-md-12 col-lg-12">
        <div class="box-shadow">
            ...
            <div class="table-div responsive">
                <table id="stock_area_rules" class="data-no-search table noclick" cellspacing="0" cellpadding="0">
                    <thead>
                    <th style="width:25px" class="hidden-xs hidden-sm">
                        <?=$this->lang->line('application_id');?>
                    </th>
                    <th class="hidden-sm hidden-xs">
                        <?=$this->lang->line('application_deposit');?>
