...
<div class="top-background">
   <table width="100%" cellspacing="0" >
        ...
        echo base_url();
    } ?><?=$core_settings->company_logo;?>" class="company-logo" /></td>
        ...
        <tr>
            <td style="vertical-align:top"><?php if ($invoice->company->province != '') {
        ?><?=$invoice->company->province; ?><?php
    } ?></td>
            <td class="right" style="vertical-align:top"></td>
        </tr>
        <tr>
            <td style="vertical-align:top"><?php if ($invoice->company->country != '') {
